...
async def get_stats() -> str:
    ...
    if EM.SHOW_PROFILE_VIEWS:
        ...
        stats += f"![Profile Views](http://img.shields.io/badge/{quote(FM.t('Profile Views'))}-{data['count']}-darkred)\n\n"
    ...
    if EM.SHOW_LINES_OF_CODE:
        ...
        stats += f"![Lines of code](https://img.shields.io/badge/{quote(FM.t('From Hello World I have written'))}-{quote(data)}-darkred)\n\n"
